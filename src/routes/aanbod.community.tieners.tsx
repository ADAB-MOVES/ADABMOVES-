...
export const Route = createFileRoute("/aanbod/community/tieners")({
  head: () => ({
    meta: [
      { title: "Community Tieners (12–17) — ADAB MOVES" },
      { name: "description", content: "Halal sport voor tieners: voetbal, basketbal, archery, kickboks, fitness — met broeders en leeftijdgenoten in jouw stad." },
      { property: "og:title", content: "Sport voor moslim-tieners — ADAB MOVES" },
...
const bullets = [
  ...
  { icon: Users, title: "Met je broeders", text: "Geen losse trainingen, een hechte groep tieners uit jouw stad." },
  { icon: Target, title: "Karakter & discipline", text: "Sport als middel om karakter en discipline op te bouwen — niet alleen techniek." },
  { icon: ShieldCheck, title: "Halal & veilig", text: "VOG-gescreende coaches die zelf rolmodellen zijn." },
];
    ...
    <>
        ...
        <div className="container-x pt-14 md:pt-20 pb-12">
          ...
          <div className="mt-6 grid lg:grid-cols-12 gap-10 items-end">
            <div className="lg:col-span-7">
              <span className="eyebrow">Community — 12 t/m 17 jaar</span>
            ...
            <p className="lg:col-span-5 text-lg text-muted-foreground leading-relaxed">
              ...
              broeders, onder begeleiding van coaches die zelf het voorbeeld geven.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="container-x py-16 md:py-20">
        <div className="rounded-3xl overflow-hidden">
          <img src={tieners} alt="Tieners trainen — boksen, pull-ups, mat" className="w-full h-auto" loading="lazy" />
        </div>
      </section>
        ...
        <div className="grid lg:grid-cols-12 gap-12">
          <div className="lg:col-span-5">
            ...
            <p className="mt-5 text-muted-foreground leading-relaxed">
              ...
              werken we aan zelfvertrouwen, leiderschap en broederschap — naast techniek en kracht.
            </p>
      ...
      <section className="container-x pb-20">
        <div className="rounded-3xl border border-border bg-card p-10 md:p-14">
          ...
          <ul className="mt-8 grid sm:grid-cols-2 gap-4 max-w-2xl">
            {["Wekelijkse multisport-training", "Wisselende disciplines per periode", "Vaste broedergroep", "Coach die je persoonlijk volgt"].map((p) => (
