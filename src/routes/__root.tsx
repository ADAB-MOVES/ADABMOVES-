...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "ADAB MOVES — Sporten met karakter voor kinderen & jongeren" },
      { name: "description", content: "Adab Moves is een Unieke multi-sport aanbieder voor kinderen en jongeren in Amsterdam en omgeving. Sport met karakter en bewegen met betekenis" },
      ...
      { property: "og:title", content: "ADAB MOVES — Sporten met karakter voor kinderen & jongeren" },
      { name: "twitter:title", content: "ADAB MOVES — Sporten met karakter voor kinderen & jongeren" },
      { property: "og:description", content: "Adab Moves is een Unieke multi-sport aanbieder voor kinderen en jongeren in Amsterdam en omgeving. Sport met karakter en bewegen met betekenis" },
      { name: "twitter:description", content: "Adab Moves is een Unieke multi-sport aanbieder voor kinderen en jongeren in Amsterdam en omgeving. Sport met karakter en bewegen met betekenis" },
    ],
    links: [
