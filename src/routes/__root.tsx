...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "ADAB MOVES versterkt kinderen en jongeren via sport, karaktervorming en gemeenschap op scholen, evenementen en in onze community." },
      ...
      { property: "og:description", content: "ADAB MOVES versterkt kinderen en jongeren via sport, karaktervorming en gemeenschap op scholen, evenementen en in onze community." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Adab Moves" },
      { property: "og:locale", content: "nl_NL" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "theme-color", content: "#1F2240" },
      { name: "twitter:title", content: "Adab Moves — Bewegen met betekenis" },
      { name: "twitter:description", content: "ADAB MOVES versterkt kinderen en jongeren via sport, karaktervorming en gemeenschap op scholen, evenementen en in onze community." },
